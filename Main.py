...
for i in range(2):
    ...
    blackPieces.append(bishop(500+375*i,0,sc_b_bishop_img,1))
    blackPieces.append(knight(375+625*i,0,sc_b_knight_img,1))
    whitePieces.append(rook(250+i*875,875,sc_w_rook_img,-1))
    whitePieces.append(bishop(500+375*i,875,sc_w_bishop_img,-1))
    whitePieces.append(knight(375+625*i,875,sc_w_knight_img,-1))

for i in range(1):
    blackPieces.append(queen(625*(i+1),0,sc_b_queen_img,1))
    blackPieces.append(king(750*(i+1),0,sc_b_king_img,1))
    whitePieces.append(queen(625*(i+1),875,sc_w_queen_img,-1))
    whitePieces.append(king(750*(i+1),875,sc_w_king_img,-1))
